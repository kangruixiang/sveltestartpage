    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div0, "class", "text-lg py-2 px-2 w-full mx-2 cursor-pointer text-stone-200 hover:bg-stone-900 hover:rounded-lg transition duration-150");
    			attr_dev(div0, "onclick", div0_onclick_value = "location.href='" + /*site*/ ctx[0].url + "'\r\n\t\t\t");
    			add_location(div0, file$2, 9, 2, 116);
    			attr_dev(div1, "class", "flex flex-row");
    			add_location(div1, file$2, 8, 1, 85);
    		},
    ...
    class Card extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*site*/ ctx[0] === undefined && !('site' in props)) {
    			console.warn("<Card> was created without expected prop 'site'");
    		}
    	}
